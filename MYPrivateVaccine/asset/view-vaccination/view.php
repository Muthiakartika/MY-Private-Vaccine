...
<head>
    ...
    <title>MY Private Vaccine - View Vaccination Status</title>
...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <!-- Sidebar - Brand -->
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="home-patient.php">
        ...
        <!-- Nav Item -->
        <li class="nav-item">
            <a class="nav-link" href="../request-vaccination/create.php">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <p class="mb-4">To allow a Patient to view the vaccination status.</p>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            ...
                            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                ...
                                $countVaccine = mysqli_query($connect, "SELECT * FROM vaccination 
                                                                                   INNER JOIN batch
                                                                                   ON vaccination.batchNo = batch.batchNo
                                                                                   WHERE status = 'Pending' 
                                                                                   ");
                                $totalPending = mysqli_num_rows($countVaccine);
                                ...
                                $listVaccine = mysqli_query($connect,
                                    "SELECT * FROM vaccine 
                                                            ...
                                                            WHERE vaccination.fullname = '".$_SESSION['fullname']."'
                                                            ");

...
<head>
    ...
    <title>MY Private Vaccine - View Record Batch</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Record Batch Tables</h6>
                        </div>

                        <div class="card-body">

                            <!-- Button Add Test -->
                            <a href="form-create.php" class="btn btn-primary">Record New Batch</a>
                            <br>
                            <br>
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <?php
                                        $no = 1;
                                        $dataBatch = mysqli_query($connect, "SELECT * FROM vaccine INNER JOIN batch ON vaccine.vaccineID = batch.vaccineID WHERE batch.centreName = '".$_SESSION['centreName']."'");
                                        while ($data_row = mysqli_fetch_array($dataBatch))
                                        {

                                    ?>
                                    <tr>
<!--                                        <td>--><?php //echo$no++?><!--</td>-->
                                        <td><?php echo$data_row['batchNo']?></td>
                                        <td><?php echo$data_row['expiryDate']?></td>
                                        <td><?php echo$data_row['quantityAvailable']?></td>
                                        <td>
                                            <a class="btn btn-dark btn-sm" href="delete-record.php?batchNo=<?php echo $data_row['batchNo']; ?>" onclick="return confirm('Anda yakin akan menghapus data ini?')">Delete</a>
                                        </td>
                                    </tr>

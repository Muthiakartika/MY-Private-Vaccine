                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                ...
                                <?php
//
                                $dataBatch = mysqli_query($connect, "SELECT * FROM vaccine");
                                while ($data_row = mysqli_fetch_array($dataBatch))
                                {
                                    ...
                                    <tr>
                                        <!--                                        <td>--><?php //echo$no++?><!--</td>-->
                                        <td><?php echo$data_row['vaccineID']?></td>
                                        <td><?php echo$data_row['manufacturer']?></td>
                                        <td><?php echo$data_row['vaccineName']?></td>
                                    </tr>
                                    <?php
                                }
                                ?>
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                ...
                                ?>
                                <form method="POST" action="record-process.php">
                                    <div class="form-group">
                                        <label>Vaccine ID</label>
                                        <input class="form-control" type="number" name="vaccineID">
                                    </div>
                                    <input class="form-control" type="hidden" name="centreName" value="<?php echo $_SESSION['centreName']; ?>">
                                    <div class="form-group">

    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <p class="mb-4">To view vaccination appointments for a healthcare centre</p>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            ...
                            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                ...
                                //Menghitung Status Pending pada Vaccination
                                $listVaccination = mysqli_query($connect,
                                    "SELECT * FROM vaccine 
                                                            INNER JOIN batch 
                                ...
                                while ($row = mysqli_fetch_array($listVaccination)){
                                    $batchNo = $row['batchNo'];
                            ...
                            <form method="POST" action="process-create.php">
                                ...
                                <div class="form-group">
                                    <a class="btn btn-primary" href="../view-batch/view.php">Back</a>
                                    <input class="btn btn-success" type="submit" value="Submit">
                                    <a href="../reject-vaccination/create.php?vaccinationID=<?php echo $vaccinationID; ?>" class="btn btn-danger">Rejected</a>
                                </div>

...
<head>
    ...
    <title>MY Private Vaccine - Login</title>
                        ...
                        <div class="col-lg-12">
                            <div class="p-5">
                                <div class="text-center">
                                    <h1 class="h4 text-gray-900 mb-4">Welcome To MY Private Vaccine</h1>
                                </div>
                                <?php
                                if(isset($_GET['message'])){
                                    if($_GET['message'] == "fail"){
                                        ...
                                        echo "<center><div class='alert alert-success' role='alert'>Register Successful</div><center>";
                                    }
                                }
                                ?>
                                <form class="user" action="asset/user-login.php" method="POST">
